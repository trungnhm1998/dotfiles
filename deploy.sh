...
ln -sfn "$HOME/dotfiles/.config/yazi" "$HOME/.config/yazi"
ln -sfn "$HOME/dotfiles/.config/nvim" "$HOME/.config/nvim"
ln -sfn "$HOME/dotfiles/.config/powershell" "$HOME/.config/powershell"
ln -sfn "$HOME/dotfiles/.config/wezterm" "$HOME/.config/wezterm"
