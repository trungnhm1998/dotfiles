...
-- Appearance
c.appearance.color                    = { red = 0.3, green = 0.6, blue = 1.0 }  -- Default/fallback color
c.appearance.appColors                = {                     -- Per-app colors
    ["Google Chrome"]     = { red = 0.95, green = 0.55, blue = 0.15 },  -- Orange
    ["iTerm2"]            = { red = 0.2,  green = 0.8,  blue = 0.4  },  -- Green
    ["Code"]              = { red = 0.3,  green = 0.5,  blue = 0.9  },  -- Blue
}
c.appearance.alpha                    = 1                   -- Opacity of active indicators
c.appearance.dimmer                   = 3.5                 -- Higher numbers increase contrast b/n focused & unfocused state
...
c.appearance.size                     = 48                  -- Size of window indicators (height when icons off)
...
c.appearance.offset.y                 = 40                  -- Distance from top of the window to render indicators
c.appearance.offset.x                 = 3                   -- Distance away from the edge of the window to render indicators
...
c.advanced.maxRefreshRate             = 1.0                 -- How aggressively to refresh Stackline. Higher = slower response time + less battery drain
